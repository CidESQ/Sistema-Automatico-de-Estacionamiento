...
$query = "SELECT * FROM carro WHERE YEAR(fecha_salida)='$año2'";
$resultado = mysqli_query($conexion, $query);

//Realizar la consulta para la suma
$query2 = "SELECT SUM(total) FROM carro WHERE YEAR(fecha_salida)='$año2'";
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->isFirstPage) { // Mostrar el título solo en la primera página
            ...
            $this->Cell(0, 10, 'REPORTE DE LAS GANANCIAS GENERADAS EN '. $GLOBALS['año2'], 0, 1, 'C');
...
$pdf->Cell(0, 10, 'Los datos que se encuentran en la tabla corresponden a los coches ingresados durante el: '.$año2, 0, 1); 
...
$pdf->Cell(0, 10, 'Las ganancias calculadas corresponden al ' . $GLOBALS['año2'] , 0, 1); 
